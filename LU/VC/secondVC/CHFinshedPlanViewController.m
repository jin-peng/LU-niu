...
#import <MJRefresh.h>
@interface CHFinshedPlanViewController (){
...
@implementation CHFinshedPlanViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vc.planID = [NSString stringWithFormat:@"%@",_dataArray[indexPath.row][@"order_no"]];
...
- (void)loadData{
    ...
    NSString *URLString =[NSString stringWithFormat:@"http://%@/Api/rules/getUserRulesList",
