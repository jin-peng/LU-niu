...
-(NSString *)doEncryptStr:(NSString *)originalStr{
    ...
    const void *vkey = (const void *) [[NSString stringWithFormat:@"%@",gkey] UTF8String];
    const void *vinitVec = (const void *) [[NSString stringWithFormat:@"%@",gIv] UTF8String];
...
-(NSString*)doDecEncryptStr:(NSString *)encryptStr withKey:(NSString *)keys{
    ...
    const void *vkey = (const void *) [keys UTF8String];
