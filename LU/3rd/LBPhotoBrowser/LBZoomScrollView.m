...
//    UIView *animationView = mgr.imageViews[mgr.currentPage];
    ...
    if (!mgr.imageViewSuperView)
    {
        rect = CGRectMake(_MainScreen_Width/ 2, _MainScreen_Height/2, 0, 0);
    }
    self.oldFrame = rect;
...
//    UIView *currentView  = mgr.imageViews[mgr.currentPage];
    ...
    if (!mgr.imageViewSuperView)
    {
        self.oldFrame = CGRectMake(_MainScreen_Width/ 2, _MainScreen_Height/2, 0, 0);
    }
